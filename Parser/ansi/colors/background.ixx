/**
 * ANSI utilities background colors setters.
 * @details @n The named module partition @code background @endcode for the module @code ansi.colors @endcode
 * exports implementations in namespace @code ansi::colors @endcode for setting colors.
 * @author danixdev1205
 */
export module ansi.colors:background;
...
namespace ansi::bg
{
    ...
    /**
     * Sets background color to regular.
     * @tparam Elem Output stream element.
     * @tparam Traits Output stream element traits.
     * @param os Output stream.
     * @return @code ESC[49m @endcode
     */
    template <class Elem, class Traits>
    ...
    /**
     * Sets background color.@n
     * 0 - 7        standard colors.@n
     * 8 - 15       high intensity colors.@n
     * 16 - 231     216 color cube.@n
     * 232 - 255    grayscale colors.
     * @tparam Elem Output stream element.
     * @tparam Traits Output stream element traits.
     * @param os Output stream.
     * @param code Color code.
     * @return @code ESC[48;5;<code>m @endcode
     */
    template <class Elem, class Traits>
    ...
    /**
     * Sets background color via RGB values.
     * @tparam Elem Output stream element.
     * @tparam Traits Output stream element traits.
     * @param os Output stream.
     ...
     * @return @code ESC[48;2;<red>;<green>;<blue>m @endcode
     */
    template <class Elem, class Traits>
